...
--exp_name unsupMT_enne_100 \
--dump_path ./dumped/ \
--reload_model 'dumped/test_enne_mlm/k7y1bvca66/best-valid_mlm_ppl.pth,dumped/test_enne_mlm/k7y1bvca66/best-valid_mlm_ppl.pth' \
--data_path ./data/en-ne/processed/en-ne/ \
--lgs 'en-ne' \
--ae_steps 'en,ne' \
--bt_steps 'en-ne-en,ne-en-ne' \
--word_shuffle 3 \
--word_dropout 0.1 \
--word_blank 0.1 \
...
--eval_bleu true \
--max_vocab 200000 \
--stopping_criterion 'valid_en-ne_mt_bleu,10' \
--validation_metrics 'valid_en-ne_mt_bleu'
