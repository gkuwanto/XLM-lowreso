...
--exp_name unsupMT_enkk_nmt_bt_test \
--dump_path ./dumped/ \
--reload_model 'dumped/test_enkk_mlm/voiplbbg4x/best-valid_mlm_ppl.pth,dumped/test_enkk_mlm/voiplbbg4x/best-valid_mlm_ppl.pth' \
