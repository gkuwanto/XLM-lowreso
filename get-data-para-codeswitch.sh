...
CS_PREPROCESSING="$REPLACE_UNICODE_PUNCT | $NORM_PUNC -l en | $REM_NON_PRINT_CHAR |                                            $TOKENIZER -l $CS -no-escape -threads $N_THREADS"
...
eval "cat $PARA_CS_TRAINUN  | $CS_PREPROCESSING > $PARA_CS_TRAIN"
...
$FASTBPE applybpe $PARA_CS_TRAIN_BPE  $PARA_CS_TRAIN  $BPE_CODES $CS_VOCAB
$MAIN_PATH/preprocess.py $FULL_VOCAB $PARA_SRC_TRAIN_BPE
$MAIN_PATH/preprocess.py $FULL_VOCAB $PARA_TGT_TRAIN_BPE
$MAIN_PATH/preprocess.py $FULL_VOCAB $PARA_CS_TRAIN_BPE
