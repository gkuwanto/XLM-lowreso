...
--exp_name unsupMT_ensi_100 \
--dump_path ./dumped/ \
--reload_model 'dumped/test_ensi_mlm/q8ze4rv8i7/best-valid_mlm_ppl.pth,dumped/test_ensi_mlm/q8ze4rv8i7/best-valid_mlm_ppl.pth' \
--data_path ./data/en-si/processed/en-si/ \
--lgs 'en-si' \
--ae_steps 'en,si' \
--bt_steps 'en-si-en,si-en-si' \
--word_shuffle 3 \
--word_dropout 0.1 \
--word_blank 0.1 \
...
--eval_bleu true \
--max_vocab 200000 \
--stopping_criterion 'valid_en-si_mt_bleu,10' \
--validation_metrics 'valid_en-si_mt_bleu'
